...
<QuickFacts
  ...
  timeline="TODO(dimi): add the timeline (e.g. May–Aug 2025)"
...
<ScreenshotSlot
  label="DormSy — marketplace home"
  caption="TODO(dimi): add a home/listings screenshot to /public/screenshots and swap ScreenshotSlot for next/image."
  className="my-12"
/>
